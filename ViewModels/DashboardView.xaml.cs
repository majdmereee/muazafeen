...
namespace RestaurantHR_App.Views
{
    public partial class DashboardView : Window
    {
        ...
        // هذه الدالة الواحدة تدير كل عمليات الفلترة (بحث وتاريخ) لحظياً!
        private void Filter_Changed(object sender, RoutedEventArgs e)
        {
            if (_vm == null || CmbDateFilter == null) return;

            // إظهار وإخفاء حقول التاريخ المخصصة بناءً على الاختيار
        ...
        private void OpenAddAttendance_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                _vm.LoadStats(); 
                Filter_Changed(null, null); // تحديث الواجهة تلقائياً
            }
        }

        private void ExportExcel_Click(object sender, RoutedEventArgs e)
        {
            var dialog = new SaveFileDialog { Filter = "Excel|*.xlsx", FileName = "تقرير.xlsx" };
