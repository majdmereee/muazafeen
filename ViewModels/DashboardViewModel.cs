...
namespace RestaurantHR_App.ViewModels
{
    public class DashboardViewModel
    {
        ...
        public DashboardViewModel()
        {
            ...
            SeedInitialData();
            LoadStats();
            ApplyFilters("", 0, null, null); // تحميل بيانات اليوم افتراضياً
        }
        ...
        private void SeedInitialData()
        {
            ...
            {
                var emp1 = new Employee { Name = "أحمد محمود", Position = "شيف", BasicSalary = 1200 };
                var emp2 = new Employee { Name = "سارّة خالد", Position = "كاشير", BasicSalary = 1000 };
        ...
        // دالة الفلترة الشاملة الحية (Live Search & Filter)
